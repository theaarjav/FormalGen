...
const JobDetails = (props) => {
    ...
    return (
        <Form>
            ...
            {props.values.jobDetails.responsibilitiesAndExpectations && props.values.jobDetails.responsibilitiesAndExpectations.map((rae, index) => (
                <div key={index}>
            ...
            {props.values.jobDetails.otherBenefits && props.values.jobDetails.otherBenefits.map((ob, index) => (
                <div key={index}>
                    {/* <div className='numbering'>{index + 1}</div> */}
